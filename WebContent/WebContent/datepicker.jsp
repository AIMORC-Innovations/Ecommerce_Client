...
$(document).ready(function() {
	...
	setTimeout(function(){ window.location.href = "home.jsp"; }, 3000);
	}
	...
	<div id="content">
		...
		<div id="form">
			<form>
				<div class="bgBox ">
				<div class="inputRow">
						<label for="dob">Select a Particular Date and Time :</label> <input type="datetime-local"
							name="date" placeholder="Enter Date_of_birth" id="date">
					</div>
						<div class="inputRow submit ">
						<input type="button" value="Submit" class="signIn" id="submit">
