...
<!------------------------------------css for cart display button------------------------------ --> / / body {
	margin: 0;
...
$.ajax({
							...
							selectDiv
									.appendChild(category_name);  */
										...
										var images = [ "images/Frock.jpg", "images/Anarkali_Gown.jpg",
											"images/Party_Wear.jpg", "images/Denim_Jacket.jpg" , "images/Salwar_Suit.jpg"];
										function myImages() {
											for (var i = 0; i < userJSON.length; i++) {
