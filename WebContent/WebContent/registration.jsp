														...
														statusCode : {
															409 : function() {
																...
																$('#content').hide(); 
																 ...
																 setTimeout(function(){ window.location.href = "http://localhost:8080/AIMORCProject/login.jsp"; }, 2000); 
															},
															200: function(){
																localStorage.clear();
...
<nav class="navbar navbar-dark navbar-expand-md"
	...
	<!-- ----------------------------form------------------------------ -->
	<div id="content">  <!-- scrool button id -->
	
	<div  id="form">
		<form>
			<div class="bgBox" id = "containerbgBox">
				<h2>Register</h2>
				 <div class="inputRow">
				<label for="email">Username :</label>
					<input type="email" name="login" id="email"
						placeholder="Enter your email" value="" autofocus>
				...
				<label for="ConfirmPassword">Confirm Password :</label>
					<input type="password" name="password" id="ConfirmPassword" value="" placeholder="ConfirmPassword">
						<small id = "conpasscheck" ></small>
				</div>
				
				<div class="inputRow">
				<label for="firstname">First Name :</label> <input type="text"
					name="firstname" id="firstname" placeholder="Enter firstname" id="firstname">
					<small id='firstnamecheck'></small>
				</div> 
				...
				<label for="dob">Date-of-Birth :</label> <input type="date"
				 ...
				 <div class="radiobutton">
					...
					<div class="custom-control custom-radio custom-control-inline">
					  <input type="radio" id="customRadioInline1" name="customRadioInline" class="custom-control-input" value="Male">
					  <label class="custom-control-label" for="customRadioInline1">  Male </label>
					</div>
					<div class="custom-control custom-radio custom-control-inline mt-2">
					  <input type="radio" id="customRadioInline2" name="customRadioInline" class="custom-control-input" value="Female">
				...
				<label for="address">Address :</label> <textarea
					name="address" placeholder="Enter Address" id="address" style="height:45px" ></textarea>
					<small id='addresscheck'><small>
						...
						<div class="group ">
						<div class="dropdown">
						 <label for="security_id">Security Question :</label>
						  <select class="combobox input-large form-control" name="security_id" id="security_id">
					...
					<!-- <button type="button" value="Register" class="signIn" id="sign_in"> Register</button> -->
			...
			<div class="bgbox">
				<div class="inputRow" id="statusDiv">
